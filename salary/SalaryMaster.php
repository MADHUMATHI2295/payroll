                                ...
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtBasicPay" required />
                                            </div>
                                            <label class="control-label col-lg-2" for="title">Medical Allowance</label>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtMedicalAllowance" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtHRA">
                                            </div>
                                            <label class="control-label col-lg-2" for="title">Special Allowance</label>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtSpecialAllowance">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtConveyanceAllowance">
                                            </div>
                                            <label class="control-label col-lg-2" for="title">Telephone Allowance</label>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtTelephoneAllowance">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtPFEmployer" required />
                                            </div>
                                            <label class="control-label col-lg-2" for="title">PF (Employee Deduction)</label>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control" id="txtPFEmployee">
                                            </div>
                                        </div>
                                        <div class="form-group" >
                                        <label class="control-label col-lg-2">PayPeriod Type</label>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="test" class="form-control" id="txtCTC">
                                            </div>
                                        </div>
                                        <!-- Buttons -->
                                        <div class="form-group">

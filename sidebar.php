        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                  ...
                  <li><a class="" href="../employee/EmpMaster.php?action=add">New Employee</a></li>
                  <li><a class="" href="../employee/EmpMaster.php?action=edit">Edit Employee</a></li>
            </ul>
            
          </li>

           <li>
            <a class="" href="../salary/SalaryMaster.php">
            <i class="icon_document_alt"></i>
